<div class="flex flex-col my-skills-content items-center justify-center w-full h-full">
  ...
  <div class="front-end-stack text-center mt-16 w-full">
    <div class="front-end-title">
      <h2 class="xl:text-2xl text-xl text-capri">Front-End Stack</h2>
    </div>
    <div class="flex flex-col xl:flex-row justify-center items-center techniques mt-8 w-full">
      <div class="native rounded-xl border-2 border-gray-200 mb-8 xl:mb-0 py-4 w-auto mx-4 shadow-xl shadow-capri">
        <h3 class="text-lg text-capri">Native Techniques</h3>
      ...
      <div class="framework rounded-xl border-2 border-gray-200 py-4 w-auto mx-4 shadow-xl shadow-capri">
        <h3 class="text-lg text-capri">Tools & Frameworks</h3>
  ...
  <div class="back-end-stack text-center mt-12 w-full">
    <div class="back-end-title">
      <h2 class="xl:text-2xl text-xl text-capri">Back-End Stack</h2>
    </div>
    <div class="flex flex-col sm:flex-row justify-center items-center techniques my-8 w-full">
      <div class="native rounded-xl border-2 border-gray-200 mb-8 sm:mb-0 py-4 w-auto mx-4 shadow-xl shadow-capri">
        <h3 class="text-lg text-capri">Native Techniques</h3>
        <div class="native-techniques flex flex-wrap mt-4 justify-center items-center" data-aos="zoom-in">
          <div class="technique-1 mt-4 auto mx-8">
            <div class="work-image mx-auto flex items-center justify-center">
  ...
  <div class="other-techniques text-center mt-12 w-full">
    <div class="other-techniques-title">
      <h2 class="xl:text-2xl text-xl text-capri">Other</h2>
    </div>
    <div class="flex flex-col justify-center items-center techniques my-8 w-full" data-aos="zoom-in">
      <div class="other rounded-xl border-2 border-gray-200 py-4 w-auto mx-4 shadow-xl shadow-capri">
        <h3 class="text-lg text-capri">Other Techniques</h3>
