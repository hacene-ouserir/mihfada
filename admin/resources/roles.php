<?php
$pageTitle = "Roles - HO Admin Panel";
      ...
      <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <div class="flex flex-col gap-10">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">Admin</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                      ...
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">Mar 13, 2026</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                    ...
                    <tr>
                      <td
                        class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <h5 class="font-medium text-black dark:text-white">2</h5>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">Subsciber</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">
                          {""}</p>
            ...
            <!-- ====== Table End -->
              <a
                class="w-full sm:w-1/4 rounded bg-primary px-6 py-2 font-medium text-gray hover:bg-opacity-90 text-center" href="./role.php">
                Add Role
              </a>
          </div>
          <!-- ====== Table Section End -->
