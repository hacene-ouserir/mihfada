<?php
$pageTitle = "My Skills - HO Admin Panel";
include_once(__DIR__ . "/includes/_head.php");
?>

<body
  x-data="{ page: 'My Skills', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
  x-init="
          ...
          <div
            ...
            <nav>
              <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary">My Skills</li>
              </ol>
            </nav>
          </div>
          <!-- Breadcrumb End -->
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">Frontend Development</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
