<div
  ...
  <div class="flex flex-col">
    ...
    <div
      ...
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="/admin/build/images/brand/brand-01.svg" alt="Brand" />
        </div>
    ...
    <div
      ...
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="/admin/build/images/brand/brand-02.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Twitter
        </p>
    ...
    <div
      ...
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="/admin/build/images/brand/brand-03.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Github
        </p>
    ...
    <div
      ...
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="/admin/build/images/brand/brand-04.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Vimeo
        </p>
    ...
    <div class="grid grid-cols-3 sm:grid-cols-5">
      <div class="flex items-center gap-3 p-2.5 xl:p-5">
        <div class="flex-shrink-0">
          <img src="/admin/build/images/brand/brand-05.svg" alt="Brand" />
        </div>
        <p class="hidden font-medium text-black dark:text-white sm:block">
          Facebook
        </p>
