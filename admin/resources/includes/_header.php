  ...
  <div
    ...
    <div class="flex items-center gap-2 sm:gap-4">
      ...
      <button
        ...
        <span class="relative block h-5.5 w-5.5 cursor-pointer">
          <span class="du-block absolute right-0 h-full w-full">
            <span
              class="relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-primary delay-[0] duration-200 ease-in-out dark:bg-white"
              :class="{ '!w-full delay-300': !sidebarToggle }"></span>
            <span
              class="relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-primary delay-150 duration-200 ease-in-out dark:bg-white"
              :class="{ '!w-full delay-400': !sidebarToggle }"></span>
            <span
              class="relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-primary delay-200 duration-200 ease-in-out dark:bg-white"
              :class="{ '!w-full delay-500': !sidebarToggle }"></span>
          </span>
          <span class="du-block absolute right-0 h-full w-full rotate-45">
            <span
              class="absolute left-2.5 top-0 block h-full w-0.5 rounded-sm bg-primary delay-300 duration-200 ease-in-out dark:bg-white"
              :class="{ '!h-0 delay-[0]': !sidebarToggle }"></span>
            <span
              class="delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-primary duration-200 ease-in-out dark:bg-white"
      ...
      <a class="block flex-shrink-0" href="/">
        <!-- <img src="/admin/build/images/logo/logo-icon.svg" alt="Logo" /> -->
      </a>
    </div>
      ...
      <form action="https://formbold.com/s/unique_form_id" method="POST">
        <div class="relative">
          <button class="absolute left-0 top-1/2 -translate-y-1/2">
            <svg
              class="fill-body hover:fill-primary dark:fill-white dark:hover:fill-primary"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
    ...
    <div class="flex items-center gap-3 2xsm:gap-7">
      <ul class="flex items-center gap-2 2xsm:gap-4">
        ...
        <li
          ...
          <a
            class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-meta-2 hover:text-primary dark:border-strokedark dark:bg-meta-4"
            href="#"
          ...
          <div
            ...
            <div class="px-4.5 py-3">
              <h5 class="text-sm font-medium text-gray">Notification</h5>
            </div>
        ...
        <li
          ...
          <div
            ...
            <div class="px-4.5 py-3">
              <h5 class="text-sm font-medium text-gray">Messages</h5>
            </div>
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
              <li>
                <a
                  ...
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="/admin/build/images/user/user-02.png" alt="User" />
                  </div>
              ...
              <li>
                <a
                  ...
                  href="messages.php">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="/admin/build/images/user/user-01.png" alt="User" />
                  </div>
              ...
              <li>
                <a
                  ...
                  href="messages.php">
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="/admin/build/images/user/user-04.png" alt="User" />
                  </div>
      ...
      <div
        ...
        <div
          ...
          <ul
            ...
            <li>
              <a
                href="/admin/resources/profile.php"
