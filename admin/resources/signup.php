...
<body
  ...
  <div class="flex h-screen overflow-hidden">
    <!-- ===== Sidebar Start ===== -->
    <include src="./includes/_sidebar.php" />
    <!-- ===== Sidebar End ===== -->
                ...
                <div class="px-26 py-17.5 text-center">
                  <a class="mb-5.5 inline-block" href="/">
                    <img
                      ...
                      src="/admin/build/images/logo/logo.svg"
                      alt="Logo" />
                    <img
                      class="dark:hidden"
                      src="/admin/build/images/logo/logo-dark.svg"
                      alt="Logo" />
                  </a>
                  ...
                  <span class="mt-15 inline-block">
                    <img
                      src="/admin/build/images/illustration/illustration-03.svg"
                      alt="illustration" />
                  </span>
                </div>
              </div>
                  ...
                  <form>
                    ...
                    <div class="mb-5">
                      <input
                        ...
                        class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-gray transition hover:bg-opacity-90" />
                    </div>
