<?php
$pageTitle = "Users - HO Admin Panel";
include_once(__DIR__ . "/includes/_head.php");
?>

<body
  x-data="{ page: 'Users', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
  x-init="
                ...
                <table class="w-full table-auto">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">Photo.png</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">admin@example.com</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">Admin</p>
                      </td>
