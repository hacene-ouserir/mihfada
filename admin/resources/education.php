<?php
$pageTitle = "Education - HO Admin Panel";
include_once(__DIR__ . "/includes/_head.php");
?>

<body
  x-data="{ page: 'Education', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
  x-init="
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">My Diplomas</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <p class="text-black dark:text-white">{
                          {
                          "title": "Bachelor's degree, Entrepreneurship",
                          "issuer_name": "University of Blida 2",
                          "issue_date": "2019 - 2023",
                          },
                          }</p>
                      </td>
                      <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
