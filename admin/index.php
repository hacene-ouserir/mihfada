<?php
include_once(__DIR__ . "/resources/includes/_head.php");
?>
...
<body
  ...
  <!-- ===== Preloader Start ===== -->
  <?php include_once(__DIR__ . "/resources/includes/_preloader.php"); ?>
  <!-- ===== Preloader End ===== -->

  <!-- ===== Page Wrapper Start ===== -->
  <div class="flex h-screen overflow-hidden">
    <!-- ===== Sidebar Start ===== -->
    <?php include_once(__DIR__ . "/resources/includes/_sidebar.php"); ?>
    <!-- ===== Sidebar End ===== -->
    ...
    <div
      ...
      <!-- ===== Header Start ===== -->
      <?php include_once(__DIR__ . "/resources/includes/_header.php"); ?>
      <!-- ===== Header End ===== -->
      ...
      <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
          ...
          <div
            ...
            <!-- ====== Chart One Start -->
            <?php include_once(__DIR__ . "/resources/includes/_chart_01.php"); ?>
            <!-- ====== Chart One End -->

            <!-- ====== Chart Two Start -->
            <?php include_once(__DIR__ . "/resources/includes/_chart_02.php"); ?>
            <!-- ====== Chart Two End -->

            <!-- ====== Chart Three Start -->
            <?php include_once(__DIR__ . "/resources/includes/_chart_03.php"); ?>
            <!-- ====== Chart Three End -->

            <!-- ====== Map One Start -->
            <?php include_once(__DIR__ . "/resources/includes/_map_01.php"); ?>
            <!-- ====== Map One End -->

            <!-- ====== Table One Start -->
            <div class="col-span-12 xl:col-span-8">
              <?php include_once(__DIR__ . "/resources/includes/_table_01.php"); ?>
            </div>
            <!-- ====== Table One End -->
            <!-- ====== Chat Card Start -->
            <div class="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
              <?php include_once(__DIR__ . "/resources/includes/_chats.php"); ?>
            </div>
            <!-- ====== Chat Card End -->
          </div>
        </div>
  ...
  <!-- ===== Page Wrapper End ===== -->
  <?php include_once(__DIR__ . "/resources/includes/_footer.php"); ?>